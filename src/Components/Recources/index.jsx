  ...
  return (
    <>
      <Container>
        <h1>Recources</h1>
        <p>
          Please find below some of the design resources and tools about Ant
          Design that we consider valuable. More of this is still being
          ...
          natural interaction, growth design, intelligent design, design
          engineering, etc.
        </p>
      </Container>
    </>
